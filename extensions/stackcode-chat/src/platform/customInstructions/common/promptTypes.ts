...
export const WORKSPACE_SKILL_FOLDERS = ['.stackcode/skills', '.claude/skills'];
export const PERSONAL_SKILL_FOLDERS = ['.stackcode/skills', '.claude/skills'];
...
export const COPILOT_INSTRUCTIONS_PATH = '.stackcode/AGENTS.md';
